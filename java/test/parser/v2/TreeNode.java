...
public class TreeNode<T extends TreeNode<T>> implements Cloneable {
	 ...
	 * 
	 * @param root
	 * @return the number of node under the specified root including the specified
	 *         root.
	 */
	...
	/**
	 * removes all children and siblings.
	 */
	@Override
	public T clone() {
		try {
			...
			that.firstNode = that.lastNode = that.nextNode = null;
			return that;
